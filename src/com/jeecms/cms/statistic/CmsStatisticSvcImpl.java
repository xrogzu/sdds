...
public class CmsStatisticSvcImpl implements CmsStatisticSvc {
	...
	public long statistic(int type, String statisticType, TimeRange timeRange,
			Map<String, Object> restrictions,CmsDepartment dept) {
		switch (type) {
		case MEMBER: {
			if (statisticType != null && statisticType != "") {
				return dao.memberStatistic(timeRange,statisticType,restrictions,dept);
			}else{
				return dao.memberStatistic(timeRange);
			}
		}
	...
	public List<Object[]> statisticMemberByTarget(
			Integer target,String statisticType, Date timeBegin,Date timeEnd,Map<String, Object> restrictions){
		return dao.statisticMemberByTarget(target, statisticType, timeBegin, timeEnd, restrictions);
	}
...
/*	private List<CmsStatistic> statisticByLastYear(int type, Calendar calendar, Map<String, Object> restrictions){
		List<CmsStatistic> list = new ArrayList<CmsStatistic>();
		int year = getYear(calendar);
		long total = 0;
		int day = 1, month = 0;
	...
	public Integer getOutOrStopPartyUserNum(Integer departId,
		...
		return dao.getOutOrStopPartyUserNum( departId,
				 decreaseType);
	}
	...
	public List<Object[]> getAllMembersNotLeave() {
		// TODO Auto-generated method stub
		return dao.getAllMembersNotLeave();
	}
