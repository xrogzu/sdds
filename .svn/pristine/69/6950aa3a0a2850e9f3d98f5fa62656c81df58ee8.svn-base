...
public abstract class BaseContent  implements Serializable {
	...
	private java.lang.String isDeptment;
	...
	public java.lang.String getIsDeptment() {
		return isDeptment;
	}

	public void setIsDeptment(java.lang.String isDeptment) {
		this.isDeptment = isDeptment;
	}
