...
public class CmsUser extends BaseCmsUser implements PriorityInterface {
	...
	public Set<RisenScore> scores;
	private String sddscpIsvalid;
	private Integer sddscpZjStatus;
	private String sddscpThsm;
	
	public Integer getSddscpZjStatus() {
		return sddscpZjStatus;
	}

	public void setSddscpZjStatus(Integer sddscpZjStatus) {
		this.sddscpZjStatus = sddscpZjStatus;
	}

	public String getSddscpThsm() {
		return sddscpThsm;
	}

	public void setSddscpThsm(String sddscpThsm) {
		this.sddscpThsm = sddscpThsm;
	}

	public String getSddscpIsvalid() {
		return sddscpIsvalid;
	}

	public void setSddscpIsvalid(String sddscpIsvalid) {
		this.sddscpIsvalid = sddscpIsvalid;
	}
