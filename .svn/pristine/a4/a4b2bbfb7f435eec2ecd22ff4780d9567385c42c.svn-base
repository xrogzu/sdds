	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(site!=null&&user!=null&&user.getUserSite(site.getId())==null){
			...
			if(userSites!=null&&userSites.size()>0){
				 ...
				 String url = s.getAdminUrl();
				 if(url.indexOf("bzds/admin") > 0){
					 url = url.replace("/bzds", "");
				 }
				 if(url.indexOf("hzds/admin") > 0){
					 url = url.replace("/hzds", "");
				 }
				 if(url.indexOf("www/admin") > 0){
					 url = url.replace("/www", "");
				 }
				 if(url.indexOf("qdds/admin") > 0){
					 url = url.replace("/qdds", "");
				 }
				 if(url.indexOf("zbds/admin") > 0){
					 url = url.replace("/zbds", "");
				 }
				 if(url.indexOf("dyds/admin") > 0){
					 url = url.replace("/dyds", "");
				 }
				 if(url.indexOf("jiningds/admin") > 0){
					 url = url.replace("/jiningds", "");
				 }
				 if(url.indexOf("tads/admin") > 0){
					 url = url.replace("/tads", "");
				 }
				 if(url.indexOf("rzds/admin") > 0){
					 url = url.replace("/rzds", "");
				 }
				 if(url.indexOf("lwds/admin") > 0){
					 url = url.replace("/lwds", "");
				 }
				 if(url.indexOf("lyds/admin") > 0){
					 url = url.replace("/lyds", "");
				 }
				 if(url.indexOf("jnds/admin") > 0){
					 url = url.replace("/jnds", "");
				 }
				 if(url.indexOf("zzds/admin") > 0){
					 url = url.replace("/zzds", "");
				 }
				 if(url.indexOf("ytds/admin") > 0){
					 url = url.replace("/ytds", "");
				 }
				 if(url.indexOf("wfds/admin") > 0){
					 url = url.replace("/wfds", "");
				 }
				 if(url.indexOf("whds/admin") > 0){
					 url = url.replace("/whds", "");
				 }
				 if(url.indexOf("dzds/admin") > 0){
					 url = url.replace("/dzds", "");
				 }
				 if(url.indexOf("lcds/admin") > 0){
					 url = url.replace("/lcds", "");
				 }
				 if(url.indexOf("index/admin") > 0){
					 url = url.replace("/www", "");
				 }
				 response.sendRedirect(url + "?_site_id_param=" + s.getId());
			}
		}
		return true;
	}
