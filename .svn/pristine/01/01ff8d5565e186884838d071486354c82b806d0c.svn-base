...
//工具条操作说明URL-----------------------
var operateExplainURL = "http://www.hzxc.gov.cn/pub/protal/xcqzfmh/bmfw/wzallsm/201312/t20131205_238557.html";
//iframe页键盘监听功能模块文件地址--------
...
function assemblyToolBar(){
	toolBarDOM = "";
                toolBarDOM = toolBarDOM+"<input style=\""+toolBarStyleText+"width:360px;\" type=\"button\" value=\"\" />";
	toolBarDOM = toolBarDOM+"<input style=\""+toolBarStyleText+"width:72px;background-image:url(/r/cms/www/risen/images\/110906204046655.gif); background-position:center; background-repeat:no-repeat;\" type=\"button\" value=\"文字放大\" title=\"文字放大\" onclick=\"fontSizeZoom('zoomIn')\" />";
	toolBarDOM = toolBarDOM+"<input style=\""+toolBarStyleText+"width:72px;background-image:url(/r/cms/www/risen/images\/110906204046655.gif); background-position:center; background-repeat:no-repeat;\" type=\"button\" value=\"文字缩小\" title=\"文字缩小\" onclick=\"fontSizeZoom('zoomOut')\" />";
	toolBarDOM = toolBarDOM+"<input style=\""+toolBarStyleText+"width:88px;background-image:url(/r/cms/www/risen/images\/110906204046608.gif); background-position:center; background-repeat:no-repeat;\" id=\"contrasbutton\" type=\"button\" value=\"开启对比度\" title=\"开启对比度\" onclick=\"highContrast()\" />";
	toolBarDOM = toolBarDOM+"<input style=\""+toolBarStyleText+"width:88px;background-image:url(/r/cms/www/risen/images\/110906204046608.gif); background-position:center; background-repeat:no-repeat;\" id=\"guidesbutton\" type=\"button\" value=\"开启辅助线\" title=\"开启辅助线\" onclick=\"guidesOpen()\" />";
	if(browserIsIE){
		toolBarDOM = toolBarDOM+"<input style=\""+toolBarStyleText+"width:72px;background-image:url(/r/cms/www/risen/images\/110906204046655.gif); background-position:center; background-repeat:no-repeat;\" type=\"button\" value=\"界面放大\" title=\"界面放大\" onclick=\"pageZoom('zoomIn')\" />";
		toolBarDOM = toolBarDOM+"<input style=\""+toolBarStyleText+"width:72px;background-image:url(/r/cms/www/risen/images\/110906204046655.gif); background-position:center; background-repeat:no-repeat;\" type=\"button\" value=\"界面缩小\" title=\"界面缩小\" onclick=\"pageZoom('zoomOut')\" />";
	}
	//toolBarDOM = toolBarDOM+"<input style=\""+toolBarStyleText+"width:72px;background-image:url(/r/cms/www/risen/images\/110906204046655.gif); background-position:center; background-repeat:no-repeat;\" type=\"button\" value=\"操作说明\" title=\"无障碍操作说明\" onclick=\"openDeclare()\" />";
	toolBarDOM = toolBarDOM+"<input style=\""+toolBarStyleText+"width:42px;background-image:url(/r/cms/www/risen/images\/110906204040013.gif); background-position:center; background-repeat:no-repeat;\" type=\"button\" value=\"重置\" title=\"重置工具条\" onclick=\"resetToolBar()\" />";
	toolBarDOM = toolBarDOM+"<input style=\""+toolBarStyleText+"width:42px;margin-right:0;background-image:url(/r/cms/www/risen/images\/110906204040013.gif); background-position:center; background-repeat:no-repeat;\" type=\"button\" value=\"关闭\" title=\"关闭工具条\" onclick=\"toolBarControl()\" />";
}
